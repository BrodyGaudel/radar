...
public class CreateOwnerCommand extends BaseCommand<String> {
    ...
    public CreateOwnerCommand(String id, String firstname, String lastname, LocalDate dateOfBirth, String placeOfBirth, Gender gender, String nationality, String cin) {
        super(id);
