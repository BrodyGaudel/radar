...
public class OwnerUpdatedEvent extends BaseEvent<String> {
    ...
    public OwnerUpdatedEvent(String id, String firstname, String lastname, LocalDate dateOfBirth, String placeOfBirth, Gender gender, String nationality, String cin) {
        super(id);
